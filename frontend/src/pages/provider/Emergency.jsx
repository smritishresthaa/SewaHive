...
export default function ProviderEmergency() {
  ...
  useEffect(() => {
    setEmergencyAvailable(!!user?.providerDetails?.emergencyAvailable);
  }, [user]);
            ...
            >
              <button
                ...
                className={`
                  ...
                  ${
                    saving || (!emergencyAvailable && !canEnableEmergency)
        ...
        <div>
          ...
          <div className="mt-3">
            <div
              className={`
                flex items-start gap-4 p-4 rounded-2xl border bg-white transition-colors
                ${emergencyAvailable ? "border-emerald-200" : "border-gray-200"}
              `}
            >
              <div
                className={`
                  h-10 w-10 rounded-xl flex items-center justify-center flex-shrink-0
                  ${emergencyAvailable ? "bg-emerald-50" : "bg-gray-100"}
                `}
              >
                <HiBolt
                  className={`text-lg ${
                    emergencyAvailable ? "text-emerald-600" : "text-gray-400"
                  }`}
                />
              </div>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2">
                  <p
                    className={`text-sm font-medium ${
                      emergencyAvailable ? "text-gray-900" : "text-gray-500"
                    }`}
                  >
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  {emergencyAvailable
                    ? "Emergency availability is currently ON and live."
                    : allMet
                    ? "Emergency availability is currently OFF. You can turn it on now."
                    : "Emergency availability is currently OFF."}
                </p>
              </div>
            </div>
          </div>
