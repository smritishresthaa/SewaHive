...
export default function PaymentConfirmation() {
  ...
  const pricingSummary = useMemo(() => {
    ...
    const pricingHint =
      mode === "fixed"
        ? "Full amount is held securely in escrow until you confirm completion."
        : mode === "range"
        ? "Range jobs collect the current approved escrow amount first. Any increase requires your approval."
        : "Quote-based jobs are paid only after quote acceptance.";
                    ...
                    <div className="flex items-start gap-2 text-sm text-gray-900">
                      ...
                      <div className="space-y-1">
                        <span className="block">
                          {booking.addressText || booking.landmark || "Location specified"}
                        </span>
              ...
              <div className="bg-white rounded-2xl shadow-sm border p-4 sm:p-6 sticky top-6">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">{pricingSummary.baseLabel}</span>
                    <span className="font-medium text-gray-900">
                      NPR {pricingSummary.baseAmount.toLocaleString()}
                    </span>
                  </div>

                  {pricingSummary.emergencyFee > 0 && (
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">Emergency Fee</span>
                      <span className="font-medium text-orange-600">
                        NPR {pricingSummary.emergencyFee.toLocaleString()}
                      </span>
                    </div>
                  )}
                ...
                <div className="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
                  <p className="text-sm text-emerald-800 flex items-start gap-2">
                    ...
                    <span>
                      <strong>How it works:</strong> Your payment will be held securely
                      in escrow. Funds are released to the provider only after you
                      confirm the service is completed satisfactorily.
                    </span>
                  </p>
                </div>
